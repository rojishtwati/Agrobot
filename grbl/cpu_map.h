...
#define cpu_map_h
  ...
  //define agrobot ko saman
     #define Solenoid_DDR		DDRG
  #define Solenoid_PORT  PORTG
  #define Solenoid 5 //MEGA2560 Digital Pin 4
  
    #define LED_light_DDR		DDRE
  #define LED_light_PORT  PORTE
  #define LED_light 5 //MEGA2560 Digital Pin 3
  #define vacuum 3 //MEGA2560 Digital pin 5

  #define humiditifier_DDR	DDRH
  #define humiditifier_PORT	PORTH
  #define humiditifier 3 //MEGA2560 Digital Pin 6
  
//#define SOIL_MOISTURE_SENSOR_PIN A2 // Define the analog pin for the soil moisture sensor
