...
//uint16_t read_analog(uint8_t pin) {
  //ADMUX = (ADMUX & 0xF0) | (pin & 0x0F);  // Set the analog input pin
      ...
      case 'M':
        ...
        switch(int_value) {
          ...
          case 7: case 8: case 9:
			...
			case 101:
			digitalWrite(6,LOW);
			//snprintf(response, sizeof(response), "LED light is ON\n");
			// Send the response string
			//for (int i = 0; response[i] != '\0'; i++) {
			//serial_write(response[i]);
			break;
			
			case 102:
			digitalWrite(6,HIGH);
			//snprintf(response, sizeof(response), "LED light is OFF\n");
			// Send the response string
			//for (int i = 0; response[i] != '\0'; i++) {
			//serial_write(response[i]);
			break;
			...
			case 103:
			digitalWrite(8,LOW);
			//snprintf(response, sizeof(response), "vacuum is ON\n");
			// Send the response string
			//for (int i = 0; response[i] != '\0'; i++) {
			//serial_write(response[i]);
			break;
			...
			case 104:
			digitalWrite(8,HIGH);
			//snprintf(response, sizeof(response), "Vacuum is OFF\n");
			// Send the response string
			//for (int i = 0; response[i] != '\0'; i++) {
			//serial_write(response[i]);
			break;
			...
			case 105:
			digitalWrite(7,LOW);
			//snprintf(response, sizeof(response), "Solenoid is ON\n");
			// Send the response string
			//for (int i = 0; response[i] != '\0'; i++) {
			//serial_write(response[i]);
			break;
			...
			case 106:
			digitalWrite(7,HIGH);
			//snprintf(response, sizeof(response), "Solenoid is OFF\n");
			// Send the response string
			//for (int i = 0; response[i] != '\0'; i++) {
			//serial_write(response[i]);
			break;
			...
			case 100:
			//moisture=read_analog();
			//moisture=analogRead(A7);
			moisture=100-map(read_analog(),0,1020,0,100);
			snprintf(response, sizeof(response), "Soil Moisture: %d\n", moisture);
			// Send the response string
			for (int i = 0; response[i] != '\0'; i++) {
			serial_write(response[i]);
			}
